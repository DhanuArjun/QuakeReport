...
public class QueryUtils {
    ...
    public static ArrayList<EarthQuake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject sampleJson = new JSONObject(SAMPLE_JSON_RESPONSE);
            //get feature array from json sample object
            JSONArray earthquakeArray = sampleJson.optJSONArray("features");
            //loop through the each feature in the array
            for(int i = 0; i < earthquakeArray.length(); i++)
            {
                ...
                String time2 = ""+time;
                EarthQuake earthquake = new EarthQuake(place,mag,time2);
